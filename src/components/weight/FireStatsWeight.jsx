...
const FireStatsWeight = (props) => {
    ...
    const baseSim = () => {
      const critDamage = baseNumbers()[0]* totalDamage * 2 * 1.4;
    ...
    const critSim = () => {
      const critDamage = extraCritNumbers()[0]* totalDamage * 2 * 1.4;
      const nonCritDamage = extraCritNumbers()[1] * totalDamage;
      return critDamage + nonCritDamage;
    }
  
    const hitSim = () => {
      const critDamage = extraHitNumbers()[0]* totalDamage * 2 * 1.4;
      const nonCritDamage = extraHitNumbers()[1] * totalDamage;
      return critDamage + nonCritDamage;
    }
  
    const spellSim = () => {
      const critDamage = baseNumbers()[0]* (totalDamage + 10) * 2 * 1.4;
      const nonCritDamage = baseNumbers()[1] * (totalDamage + 10);
      return critDamage + nonCritDamage;
    ...
    console.log("hitDiff", hitDiff);
    console.log("spellDiff", spellDiff);
  ...
  export default FireStatsWeight;